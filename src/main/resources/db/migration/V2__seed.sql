-- ============================================================================
-- OmniSolve Reference Data Seed
-- ============================================================================
-- This file contains all reference data for the OmniSolve platform:
-- - Compliance standards (ISO 9001, ISO 14001, ISO 45001)
-- - ISO clauses with hierarchical structure
-- - Document types and statuses
-- - Departments
-- - Permissions
-- - Incident types, severities, and statuses
-- - Demo organisation with roles and permissions
-- ============================================================================
...
-- Top-level clause groups (for navigation)
...
-- Key ISO 14001 operational clauses
INSERT INTO clauses (standard_id, code, title, description, parent_code, level, sort_order) VALUES
...
-- Key ISO 45001 operational clauses
INSERT INTO clauses (standard_id, code, title, description, parent_code, level, sort_order) VALUES
...
-- ============================================================================
-- DEMO ORGANISATION ROLE PERMISSIONS
-- ============================================================================
...
-- Quality Manager: documents, audits, reports
INSERT INTO role_permissions (role_id, permission_id)
SELECT 
    r.id AS role_id,
    p.id AS permission_id
...
-- Safety Manager: incidents, risks, audits, reports
INSERT INTO role_permissions (role_id, permission_id)
SELECT 
    r.id AS role_id,
    p.id AS permission_id
...
-- Environmental Manager: documents, incidents, risks, reports
INSERT INTO role_permissions (role_id, permission_id)
SELECT 
    r.id AS role_id,
    p.id AS permission_id
...
-- Supervisor: dashboard, risks, reports
INSERT INTO role_permissions (role_id, permission_id)
SELECT 
    r.id AS role_id,
    p.id AS permission_id
...
-- Insert demo incidents with various types, severities, and statuses
...
-- Add investigations for closed incidents
...
-- Add corrective actions for incidents
...
-- Insert demo documents with various types, statuses, and clause links
...
-- Link documents to relevant ISO clauses
